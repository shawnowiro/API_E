    ...
    public function about_content()
    {
        ...
        public function Signup_content()
        {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $password = password_hash($_POST['exampleInputPassword1'], PASSWORD_DEFAULT); // Hash the password
                $phone = $_POST['phone'];
            ...
            <div class="form-wrapper">
                <form action=" " method="POST"> <!-- Added method POST -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Enter last name"> <!-- Added name attribute -->
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" name="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"> <!-- Added name attribute -->
                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                    </div>
                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter phone number"> <!-- Added name attribute -->
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword1" name="exampleInputPassword1" placeholder="Password"> <!-- Added name attribute -->
                    </div>
